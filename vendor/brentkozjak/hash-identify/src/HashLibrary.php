...
/**
 * The hashing algorithms and associated regular expressions
 *
 * @see https://github.com/psypanda/hashID/blob/master/prototypes.json
 */
class HashLibrary
{
    /**
     * Returns all hashing modes that correspond to each regular expression.
     * @return array The hashing modes
     */
